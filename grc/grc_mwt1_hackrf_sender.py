...
class grc_mwt1_hackrf_sender(gr.top_block):

    def __init__(self):
        gr.top_block.__init__(self, "grc_mwt1_hackrf_sender")
        ...
        self.connect((self.mwt1_mwt1_packet_encoder_0, 0), (self.digital_gmsk_mod_0, 0))
