...
# Title: grc_mwt1_test_local_loop
# Author: Jerome Nokin
...
class grc_mwt1_test_local_loop(gr.top_block):

    def __init__(self):
        gr.top_block.__init__(self, "grc_mwt1_test_local_loop")
        ...
        self.mwt1_mwt1_packet_encoder_0 = mwt1.mwt1_packet_mod_base(mwt1.mwt1_packet_encoder(
        ...
        self.connect((self.mwt1_mwt1_packet_decoder_0, 0), (self.blocks_null_sink_0, 0))
        self.connect((self.blocks_throttle_0, 0), (self.digital_gmsk_mod_0, 0))
        self.connect((self.mwt1_mwt1_packet_encoder_0, 0), (self.blocks_throttle_0, 0))
